...
public class Task11b {
    ...
    public static void main(String[] args) throws IOException {
        // String input = "src/main/resources/task11/11b-sample.input";
        ...
        long result = allDirectedPaths.getAllPaths("svr", "fft", false, 600).size();
        result *= allDirectedPaths.getAllPaths("fft", "dac", false, 600).size();
        result *= allDirectedPaths.getAllPaths("dac", "out", false, 600).size();
